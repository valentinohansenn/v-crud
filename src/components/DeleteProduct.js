...
export function DeleteProduct({id}) {
    ...
    const clickHandler = async () => {
        ...
        const parsedDate = isNaN(Date.parse(isDeleted)) ? new Date() : new Date(isDeleted);
        await router.push("/");
    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="bg-white">
                ...
                <AlertDialogFooter>
                    <AlertDialogCancel className="hover:bg-black hover:text-white rounded">Cancel</AlertDialogCancel>
                    <AlertDialogAction
