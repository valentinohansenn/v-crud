        ...
        <Link
            ...
            <div className="flex flex-col">
                <div className="flex h-3/5 justify-center">
                    <div className="flex">
                        <Image src={thumbnail} alt={title} width={422} height={150} className="object-center h-auto"/>
                    </div>
                </div>
                <div className="flex flex-col h-2/5 gap-1">
                    <span className="font-semibold text-xl font-sans pt-1">
                        {title}
                    </span>
                    <div className="pt-1">
                    ...
                    <span className="flex pt-1 font-semibold font-sans">
                        <span className="flex items-end text-green-600 text-xl pr-2">-{discountPercentage}%</span>
